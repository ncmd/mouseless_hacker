...
# })
define_conditional_multipurpose_modmap(lambda wm_class: wm_class in ("Tilix||Brave-browser|Google-chrome|VirtualBox Machine|VirtualBox Manager|Github Desktop"), {
    Key.BACKSPACE: [Key.BACKSPACE, Key.LEFT_META],
    Key.SPACE: [Key.SPACE, Key.LEFT_CTRL],
    Key.RIGHT_SHIFT: [Key.GRAVE, Key.RIGHT_SHIFT],
})
